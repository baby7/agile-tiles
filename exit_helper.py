...
# 打包命令
# nuitka --onefile --standalone --windows-console-mode=disable --windows-icon-from-ico=run_util/util.ico --output-dir=out --windows-uac-admin --lto=yes --jobs=8 --show-progress --show-memory exit_helper.py
