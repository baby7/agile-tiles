...
from src.my_component.AgileTilesAcrylicDialog.AcrylicDialog import AcrylicDialog
from src.my_component.AgileTilesTitleBar.AgileTilesTitleBar import AgileTilesTitleBar
from src.module import init_module
from src.ui import style_util


class AgileTilesFramelessDialog(AcrylicDialog):
    ...
    def __init__(self, parent=None, is_dark=None, form_theme_mode="Acrylic", form_theme_transparency=50):
        ...
        self.form_theme_mode = form_theme_mode if form_theme_mode else "Acrylic"
        self.form_theme_transparency = form_theme_transparency if form_theme_transparency else 50
        # 窗口设置
