...
from qframelesswindow.windows.c_structures import (ACCENT_POLICY, ACCENT_STATE, DWMNCRENDERINGPOLICY,
                           DWMWINDOWATTRIBUTE, MARGINS,
                           WINDOWCOMPOSITIONATTRIB,
                           WINDOWCOMPOSITIONATTRIBDATA, DWM_BLURBEHIND)
from qframelesswindow.utils.win32_utils import isGreaterEqualWin10, isGreaterEqualWin11, isCompositionEnabled


class BaseWindowsWindowEffect:
