...
from src.component.titlebar import TitleBar
...
from src.component.BaseWindowsWindowEffect.BaseWindowsWindowEffect import BaseWindowsWindowEffect


class WindowsFramelessQDialog(WindowsFramelessWindowBase, QDialog):
...
class AcrylicDialog(WindowsFramelessQDialog):
    """ A frameless window with acrylic effect """

    windowEffect = None
    titleBar = None
    _isResizeEnabled = None
    # 自定义标识符
