...
from src.card.main_card.SettingCard.setting.setting_location_form import Ui_Form
...
class SettingLocationWindow(AgileTilesAcrylicWindow, Ui_Form):
    ...
    def __init__(self, parent=None, use_parent=None, setting_config=None):
        super(SettingLocationWindow, self).__init__(is_dark=use_parent.is_dark, form_theme_mode=use_parent.form_theme_mode,
