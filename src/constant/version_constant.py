...
update_map_info = {
    ...
    # "v0.5.8": [
    #     "注册时校验昵称敏感词",
    #     "查看信息菜单的查看图片增加部分随机图片功能，图片模块挪到文字模块前面",
    #     "版本校验逻辑调整",
    #     "游戏小黑屋默认中文",
    #     "游戏信任的进化改为线上链接形式，转为中文",
    #     "修复部分字体未同步的修改的问题",
    #     "修复游戏我的文字修仙全靠刷的颜色主题不对的问题",
    # ],
    # "v0.5.9": [
    #     "登录界面增加更新功能",
    #     "安装界面给出快捷方式选项",
    ...
    #     "日志文件做调整，正式环境不输出日志",
    #     "部分窗口提示第三方资源不进行数据同步",
    #     "版本更新逻辑调整，从当前版本到最新版本有强制更新就更新",
    # ],
    # "v0.6.0": [
    #     "登录界面添加开机自启动选项",
    #     "智能对话、游戏、工具模块的图标都改为卡通或官方图标",
    #     "日志文件做调整，引导界面的呼出方式画面调整，改到左侧",
    #     "修复部分情况下弹窗会出现的卡死问题",
    #     "修复使用安装包安装后开机自启动未生效的问题",
    # ],
    "v1.0.0": [
        "提交第一个版本",
    ],
